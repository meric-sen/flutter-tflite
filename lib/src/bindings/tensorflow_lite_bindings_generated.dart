...
base class TfLiteModel extends ffi.Opaque {}

base class TfLiteInterpreterOptions extends ffi.Opaque {}

/// WARNING: This is an experimental interface that is subject to change.
base class TfLiteDelegate extends ffi.Struct {
...
base class TfLiteContext extends ffi.Struct {
...
/// indices
base class TfLiteIntArray extends ffi.Opaque {}

base class TfLiteTensor extends ffi.Struct {
...
base class TfLitePtrUnion extends ffi.Union {
...
base class TfLiteFloat16 extends ffi.Struct {
  @ffi.Uint16()
  external int data;
}

/// Single-precision complex data type compatible with the C99 definition.
base class TfLiteComplex64 extends ffi.Struct {
...
base class TfLiteComplex128 extends ffi.Struct {
  /// real and imaginary parts, respectively.
  @ffi.Double()
  external double re;
...
/// back to float using:
/// real_value = scale * (quantized_value - zero_point)
base class TfLiteQuantizationParams extends ffi.Struct {
  @ffi.Float()
...
base class TfLiteQuantization extends ffi.Struct {
...
base class TfLiteSparsity extends ffi.Struct {
...
base class TfLiteDimensionMetadata extends ffi.Struct {
  @ffi.Int32()
  external int format;
...
base class TfLiteNode extends ffi.Struct {
...
base class TfLiteRegistration extends ffi.Struct {
...
base class TfLiteRegistrationExternal extends ffi.Opaque {}
...
/// change.
base class TfLiteExternalContext extends ffi.Struct {
  @ffi.Int32()
  external int type;
...
base class TfLiteDelegateParams extends ffi.Struct {
  external ffi.Pointer<TfLiteDelegate> delegate;
...
base class TfLiteEvalTensor extends ffi.Struct {
  /// A union of data pointers. The appropriate type should be used for a typed
  /// tensor based on `type`.
  external TfLitePtrUnion data;
...
///
/// WARNING: This is an experimental interface that is subject to change.
base class TfLiteOpaqueDelegateBuilder extends ffi.Struct {
  /// Data that delegate needs to identify itself. This data is owned by the
  /// delegate. The delegate is owned in the user code, so the delegate is
  /// responsible for deallocating this when it is destroyed.
  external ffi.Pointer<ffi.Void> data;
...
base class TfLiteOpaqueContext extends ffi.Opaque {}

base class TfLiteOpaqueDelegateStruct extends ffi.Opaque {}

base class TfLiteOpaqueTensor extends ffi.Opaque {}

base class TfLiteInterpreter extends ffi.Opaque {}
...
base class TfLiteOpaqueNode extends ffi.Opaque {}

typedef va_list = __builtin_va_list;
typedef __builtin_va_list = ffi.Pointer<ffi.Char>;

base class TfLiteSignatureRunner extends ffi.Opaque {}
...
base class TfLiteRegistration_V1 extends ffi.Struct {
  external ffi.Pointer<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(ffi.Pointer<TfLiteContext> context,
              ffi.Pointer<ffi.Char> buffer, ffi.Size length)>> init;
...
base class TfLiteCoreMlDelegateOptions extends ffi.Struct {
...
base class TFLGpuDelegateOptions extends ffi.Struct {
...
base class TfLiteXNNPackDelegateWeightsCache extends ffi.Opaque {}

base class TfLiteXNNPackDelegateOptions extends ffi.Struct {
...
/// may break inference.
base class TfLiteGpuDelegateOptionsV2 extends ffi.Struct {
